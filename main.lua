...
function FanQiePlugin:showBookList(books)
    ...
    -- Refresh button at top (closes current menu before refreshing)
    table.insert(items, {
        text = _("⟳ 刷新书架"),
        callback = function()
    ...
    local book_menu = Menu:new{
        ...
        close_callback = function()
            if _state.active_menu == book_menu then
                _state.active_menu = nil
            end
        end,
    }
    _state.active_menu = book_menu
